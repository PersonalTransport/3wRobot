...
it would be helpful to know something about the mpasm features I use such as [macro's](../blob/master/docs/macro.md) and [relocatable code](../blob/master/docs/code.md).
